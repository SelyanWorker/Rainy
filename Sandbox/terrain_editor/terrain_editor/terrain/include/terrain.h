...
namespace te
{
    ...
    {
    public:
        explicit TerrainArea(Vector2i firstIndex) : FirstIndex(firstIndex) {}
    ...
    public:
        Terrain(TerrainInitSize columns,
                TerrainInitSize rows,
                Rainy::Image *heightMap = nullptr,
                Rainy::Image *normalsMap = nullptr,
                float heightMod = 1.f);
        ...
        bool RayIntersection(Vector3f &dest,
    ...
    private:
        ...
        Vector3f BinarySearch(Vector3f rayStartPoint,
                              Vector3f ray,
                              float start,
                              float end,

...
namespace ls {
	...
	protected:
		virtual void ModifyVertexPositions(LandscapePart* lp, Brush* brush);

		virtual void ModifyVertexNormals(LandscapePart* lp);
	...
	public:
		explicit SmoothTool(Landscape* landscape_ptr, float strength, uint8_t levels);

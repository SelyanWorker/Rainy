...
namespace ls {
	...
	public:
		...
		SectionPlus(Vector3f position, float vertexStep, uint32_t stepCount);
	...
	{
	public:
		LandscapePlus(uint32_t width, uint32_t length, float sectionWorldSize, uint32_t sectionPartCount);

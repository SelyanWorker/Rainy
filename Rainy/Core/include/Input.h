...
namespace Rainy {
	...
	public:
		...
		static bool IsMouseKeyPressed(uint32_t mouseKeyCode) { return m_input->IsMouseKeyPressedImpl(mouseKeyCode); }
		static bool IsMouseKeyReleased(uint32_t mouseKeyCode) { return m_input->IsMouseKeyReleasedImpl(mouseKeyCode); }
		static std::pair<float, float> GetCursorPosition() { return m_input->GetCursorPositionImpl(); }

...
namespace Rainy {
	...
	enum EventCategory
	{
		MouseEvent, KeyEvent, ApplicationEvent
	};

	enum EventType
	{
		None = 0,
		ApplicationUpdate = 1, ApplicationRender = 2, ApplicationClose = 3,
		MouseMoved = 11, MouseKeyPressed = 12, MouseKeyRelease = 13, MouseScroll = 14,
		KeyPressed = 21, KeyRelease = 22, KeyRepeat = 23, CharInput = 24,
		WindowClose = 31, WindowResize = 32, WindowMove = 33
	};
